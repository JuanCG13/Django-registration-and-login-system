...
from .models import Gastos as model_data
from .forms import *
...
class DataCreate(SuccessMessageMixin, CreateView): 
    ...
    def form_valid(self, form):
        ...
        save_historial = Historial(usuario="{}".format(current_user.username),accion="Se ha agregado un gasto")
        save_historial.save()
...
class DataUpdate(SuccessMessageMixin, UpdateView): 
    ...
    def form_valid(self, form):
        ...
        save_historial = Historial(usuario="{}".format(current_user.username),accion="Se ha actualizado un gasto")
        save_historial.save()
...
class DataDelete(SuccessMessageMixin, DeleteView):
    ...
    def get_queryset(self):
        ...
        if self.request.method == 'POST':
            ...
            save_historial = Historial(usuario="{}".format(current_user.username),accion="Se ha eliminado un gasto")
            save_historial.save()
